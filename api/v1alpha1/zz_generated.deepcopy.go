...
func (in *Ingress) DeepCopyInto(out *Ingress) {
	*out = *in
	if in.IngressConfigs != nil {
		in, out := &in.IngressConfigs, &out.IngressConfigs
		*out = make([]IngressConfigs, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressAddresses) DeepCopyInto(out *IngressAddresses) {
	*out = *in
	if in.RtmpBaseUrl != nil {
		in, out := &in.RtmpBaseUrl, &out.RtmpBaseUrl
		*out = new(string)
		**out = **in
	}
	if in.WhipBaseUrl != nil {
		in, out := &in.WhipBaseUrl, &out.WhipBaseUrl
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressAddresses.
func (in *IngressAddresses) DeepCopy() *IngressAddresses {
	if in == nil {
		return nil
	}
	out := new(IngressAddresses)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IngressConfigs) DeepCopyInto(out *IngressConfigs) {
	*out = *in
	...
	if in.ParticipantIdentity != nil {
		in, out := &in.ParticipantIdentity, &out.ParticipantIdentity
		*out = new(string)
		**out = **in
	}
	if in.ParticipantName != nil {
		in, out := &in.ParticipantName, &out.ParticipantName
		*out = new(string)
		**out = **in
	}
	if in.BypassTranscoding != nil {
		in, out := &in.BypassTranscoding, &out.BypassTranscoding
		*out = new(bool)
		**out = **in
	}
	if in.URL != nil {
