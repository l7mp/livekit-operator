...
func createEnvoyLiveKitIngressGateway(lkMesh *lkstnv1a1.LiveKitMesh) *gwapiv1.Gateway {
	...
	return &gwapiv1.Gateway{
		...
		Spec: gwapiv1.GatewaySpec{
			...
			Listeners: []gwapiv1.Listener{
				{
					Name:     gwapiv1.SectionName(getEnvoyLiveKitIngressGatewayListenerName(lkMesh.Name, "rtmp-whip")),
					Protocol: gwapiv1.HTTPSProtocolType,
					Hostname: &hostName,
					Port:     gwapiv1.PortNumber(443),
					TLS: &gwapiv1.GatewayTLSConfig{
...
func createEnvoyLiveKitIngressHTTPRoute(lkMesh *lkstnv1a1.LiveKitMesh) *gwapiv1.HTTPRoute {

	name := getEnvoyLiveKitServerTCPRouteName(lkMesh.Name)
	ns := gwapiv1.Namespace(lkMesh.Namespace)
...
//func createEnvoyTCPRoute(lkMesh *lkstnv1a1.LiveKitMesh) *gwapiv1a2.TCPRoute {
//	name := getEnvoyLiveKitServerTCPRouteName(lkMesh.Name)
//	ns := gwapiv1.Namespace(lkMesh.Namespace)
//
//	labels := map[string]string{
